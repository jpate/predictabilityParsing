...
class StreamASpansStreamBContextsEstimator(
  ...
  */
  ...
  def computePartialCountsSingle( s:List[WordPair] ) = populateChart( s ).toPartialCounts
...
class StreamASpansStreamBContextsParser {
